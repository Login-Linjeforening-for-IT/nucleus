...
import AllComitees from '../functions/allCommittees';
import Copyright from '../functions/copyright';
import Dropdown from '../functions/dropdown';
import Social from '../functions/social';
import person from '../functions/person';
import styret from '../functions/styret';
...
export default function LegacyAboutScreen( { navigation }) {
