import registerForPushNotificationsAsync from '../notificationComponents/registerForPushNotificationAsync';
import removeDuplicatesAndOld from '../eventComponents/removeDuplicatesAndOld';
import notificationSetup from '../notificationComponents/notificationSetup';
import updateCalendar from '../eventComponents/calendar/updateCalendar';
import createCalendar from '../eventComponents/calendar/createCalendar';
import calendarExists from '../eventComponents/calendar/calendarExists';
import OldEventCardLocation from './oldEventCardLocation';
import LegacyCategorySquare from './legacyCategorySquare';
...
import GreenLight from '../eventComponents/greenLight';
import SmallCheck from '../eventComponents/smallCheck';
import GrayLight from '../eventComponents/grayLight';
...
import MonthNO from '../eventComponents/monthNO';
import MonthEN from '../eventComponents/monthEN';
import CheckedBox from '../functions/checkedBox';
import Check from '../eventComponents/check';
 ...
 * @returns EventScreen
 */
export default function OldEventScreen({navigation}) { // Exports the screen
    ...
    function tekkomArray() {
        let array = [];
        if (notification["tekkom10m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["tekkom30m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["tekkom1h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["tekkom2h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["tekkom3h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["tekkom6h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["tekkom1d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["tekkom2d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["tekkom1w"]) {
            array.push(1)
        } else 
            array.push(0);
    ...
    function socialArray() {
        let array = [];
        if (notification["social10m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["social30m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["social1h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["social2h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["social3h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["social6h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["social1d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["social2d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["social1w"]) {
            array.push(1)
        } else 
            array.push(0);
    ...
    function ctfArray() {
        let array = [];
        if (notification["ctf10m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["ctf30m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["ctf1h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["ctf2h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["ctf3h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["ctf6h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["ctf1d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["ctf2d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["ctf1w"]) {
            array.push(1)
        } else 
            array.push(0);
    ...
    function karrieredagArray() {
        let array = [];
        if (notification["karrieredag10m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["karrieredag30m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["karrieredag1h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["karrieredag2h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["karrieredag3h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["karrieredag6h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["karrieredag1d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["karrieredag2d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["karrieredag1w"]) {
            array.push(1)
        } else 
            array.push(0);
    ...
    function fadderukaArray() {
        let array = [];
        if (notification["fadderuka10m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["fadderuka30m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["fadderuka1h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["fadderuka2h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["fadderuka3h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["fadderuka6h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["fadderuka1d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["fadderuka2d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["fadderuka1w"]) {
            array.push(1)
        } else 
            array.push(0);
    ...
    function bedpresArray() {
        let array = [];
        if (notification["bedpres10m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["bedpres30m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["bedpres1h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["bedpres2h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["bedpres3h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["bedpres6h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["bedpres1d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["bedpres2d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["bedpres1w"]) {
            array.push(1)
        } else 
            array.push(0);
    ...
    function loginArray() {
        let array = [];
        if (notification["login10m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["login30m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["login1h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["login2h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["login3h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["login6h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["login1d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["login2d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["login1w"]) {
            array.push(1)
        } else 
            array.push(0);
    ...
    function annetArray() {
        let array = [];
        if (notification["annet10m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["annet30m"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["annet1h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["annet2h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["annet3h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["annet6h"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["annet1d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["annet2d"]) {
            array.push(1)
        } else 
            array.push(0);
        

        if (notification["annet1w"]) {
            array.push(1)
        } else 
            array.push(0);
    ...
    function notificationArray(category) {
        ...
        switch (cat) {
            ...
            case "ctf":
                return ctfArray();
            case "karrieredag":
                return karrieredagArray();
            case "fadderuka":
                return fadderukaArray();
            case "bedpres":
                return bedpresArray();
            case "login":
                return loginArray();
   ...
   */
    async function executeDownload(clickedEvents, calendarID) {
        ...
        if (typeof await calendarExists(calendarID) != "undefined") 
            await updateCalendar(clickedEvents, calendarID)
         else 
   ...
   */
        ...
        try {
            ...
            (async () => { // Immediately invoked function expression (IIFE)
                try {
                    ...
                    setEvents([... cache]) // If cached events was found save them in event array
                } catch (e) {
                    console.warn('Failed to fetch cache: ' + e)
                } // If cache was not found tell the user cache wasnt found (custom notification needs to go here)
            })
        }
    }
    ...
    const Filter = () => { // --- PARENT FILTER FUNCTION ---
        ...
        // If both are null or 0 update the displayed events else 
            setRenderedArray([...events])
        ...
        (async () => { // IIFE
            ...
            if (unique) {
                for (let i = 0; i < unique.length; i++) { // Finds the firstcoming event
                    if (CompareDates((unique[i]).startt, (unique[storedID]).startt) == true) 
                        storedID = i;
                ...
                if (unique[storedID]) 
                    await AsyncStorage.setItem("firstEvent", JSON.stringify((unique[storedID])))
    ...
    if (events.length > 0 && events.length !== renderedArray.length) { // --- CHECKS FOR AND FIXES INCORRECT RENDER ---
        if (!filter.input) 
            clickedCategory.length == 0 ? RenderEvents() : null
         // Fixes any errors if the user is not currently filtering else 
            filter.input.length == 0 && clickedCategory.length == 0 ? RenderEvents() : null
    ...
    <View>
        <StatusBar style={
            theme == 0 || theme == 2 || theme == 3 ? 'light' : 'dark'
        }/> 
        {/* ========================= DISPLAY CONTENT ========================= */}
        <View style={
            {
                ...
                <View style={
                    ...
                    <TextInput ref={textInputRef}
                        style={
                            {
                                ...ES.filterText,
                                backgroundColor: FetchColor(theme, 'DARKER')
                            }
                        }
                        maxLength={40}
                        placeholder='Søk..'
                    ...
                    <TouchableOpacity onPress={
                        () => filterInput(null) + setRenderedArray([...events]) + setClickedCategory([]) + textInputRef.current.clear()
                    }>
                        <Image style={
                                ES.filterResetIcon
                            }
                            source={
                                theme == 0 || theme == 2 || theme == 3 ? require('../../assets/icons/reset.png') : require('../../assets/icons/reset-black.png')
                            }/>
                    </TouchableOpacity>
                </View>
                        ...
                        renderItem={
                            ({item}) => (
                                <View style={
                                    ...
                                    {
                                    clickedCategory.includes(item) ? <TouchableOpacity onPress={
                                        () => setClickedCategory(clickedCategory.filter((x) => x.id !== item.id))
                                    }>
                                        <View>
                                            <Text style={
                                                {
            ...
            {
            renderedArray != null ? renderedArray.length > 0 ? 
            <FlatList style={
                    {minHeight: '100%'}
                }
                showsVerticalScrollIndicator={false}
                ...
                renderItem={
                    ({item, index}) => (
                        ...
                        <View style={
                            {
                                marginTop: search.status && !index ? -10 : 0
                            }
                        }>
                            <TouchableOpacity onPress={
                                ...
                                <Card>
                                    <View style={
                                        ...
                                        <View> 
                                            {
                                                LegacyCategorySquare(item.category)
                                            }
                                            <Text style={
                                                {
                                                    ...ES.eventCardDayText,
                                        ...
                                        {
                                        OldEventCardLocation(item, theme, lang)
                                    }
                                        <View style={
                                            ES.view3
                                        }>
                                            {
                                                clickedEvents.some(event => event.eventID === item.eventID) ? <TouchableOpacity onPress={
                                                    () => {
                                ...
                                {
                                index == renderedArray.length - 1 ? <Text style={
                                    {
                                        ...T.contact,
                ...
                <Text style={
                    ...
                    {
                    lang ? "Sjekk nettverkstilkoblingen din og prøv igjen. Kontakt TEKKOM dersom problemet vedvarer." : "Check your wifi connection and try again. Contact TEKKOM if the issue persists."
                }</Text>
            </View> : <View>
                <View style={
                    {height: '50%'}
                ...
                <Text style={
                    {
                        ...T.centeredOppositeColor,
                        color: FetchColor(theme, 'OPPOSITETEXTCOLOR')
                    }
                }>
                    {
                    lang ? "Ingen treff" : "No matching events"
                }</Text>
            </View> : <View style={
                {
                    alignSelf: 'center',
        ...
        <View style={
            ...
            <TouchableOpacity style={MS.logoBackground}>
                <Image style={
                    ...
                    source={
                        theme == 0 || theme == 2 || theme == 3 ? require('../../assets/logo/loginText.png') : require('../../assets/logo/loginText-black.png')
                    }/>
            </TouchableOpacity>
            <View style={
                GS.loginStatus
            ...
            {
            renderedArray != null ? <View style={
                MS.multiTop
            }>
                {
                clickedEvents.length > 0 ? 
                <TouchableOpacity onPress={
                    async () => await handleDownload()
                }>
                    <Image style={
                            MS.multiIcon
                        }
                        source={
                            theme == 0 || theme == 2 || theme == 3 ? timeSinceDownload() >= 1000 ? require('../../assets/icons/download.png') : require('../../assets/icons/download-orange.png') : require('../../assets/icons/download-black.png')
                        }/>
                ...
                <TouchableOpacity onPress={
                    ...
                    {
                    search.status ? <Image style={
                            MS.multiIcon
                        }
                        source={
                            require('../../assets/icons/filter-orange.png')
                        }/> : <Image style={
                            MS.multiIcon
                        }
                        source={
                            theme == 0 || theme == 2 || theme == 3 ? require('../../assets/icons/filter.png') : require('../../assets/icons/filter-black.png')
                        }/>
                } 
                </TouchableOpacity> : null
            } 
        ...
        <View style={
            ...
            <TouchableOpacity style={
                ...
                <Image style={
                    ...
                    source={
                        theme == 0 || theme == 2 || theme == 3 ? require('../../assets/menu/menu.png') : require('../../assets/menu/menu-black.png')
                    }/>
            </TouchableOpacity>
        </View>
    </View>
