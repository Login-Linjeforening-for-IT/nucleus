...
export default function OldMenuScreen({ navigation }) {
  ...
  const [setting] = useState([
      ...
      {id: '3', nav: !oldUI ? 'BoardScreen':'LegacyBoardScreen', titleNO: 'Styret', titleEN: 'The Board'},
      {id: '4', nav: !oldUI ? 'AboutScreen':'LegacyAboutScreen', titleNO: 'Om oss', titleEN: 'About Login'},
