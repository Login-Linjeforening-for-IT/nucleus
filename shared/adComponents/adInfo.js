...
export default function AdInfo(props) {
    ...
    const deadline = ad.application_deadline 
    
    return(
        <View style={AS.adInfoView}>
            <View style={AS.adInfoInsideView}>
                <Text style={{...AS.adInfoType, color: FetchColor(theme, 'OPPOSITETEXTCOLOR')}}>{lang ? "Sted: " : "Location: "}</Text>
                <Text style={{...AS.adInfo, color: FetchColor(theme, 'TEXTCOLOR')}}>{loc}</Text>
            </View>
            <View style={AS.adInfoInsideView}>
                <Text style={{...AS.adInfoType, color: FetchColor(theme, 'OPPOSITETEXTCOLOR')}}>{lang ? "Ansettelsesform: " : "Position: "}</Text>
                <Text style={{...AS.adInfo, color: FetchColor(theme, 'TEXTCOLOR')}}>{type}</Text>
            </View>
            <View style={AS.adInfoInsideView}>
                <Text style={{...AS.adInfoType, color: FetchColor(theme, 'OPPOSITETEXTCOLOR')}}>{lang ? "Frist: " : "Deadline: "}</Text>
