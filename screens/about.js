    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      <Card>
        ...
        <View style={GS.row}>
          <Text>{Line(60,5)}</Text>
          <View>
            <Text style={T.boldWithLine}>Foreningen drives av frivillige studenter som arbeider for at du skal få mest mulig ut av studiene dine ved  NTNU.</Text>
          </View>
        </View>
        {Space(5)}
