        ...
        <View style={{...GS.content, backgroundColor: FetchColor(theme, 'BACKGROUND')}}>
            ...
            <Card>
                ...
                <View style={{flexDirection: 'row'}}>
                    <EventLocation
                        room={usersData.roomno}
                        campus={usersData.campus}
...
function JoinButton({theme, lang, link, updateStorage}) {
    if (link) {
        return(
...
function Category({item, theme, lang}) {
    return (
        <View style={ES.specificEventInfoView}>
...
function Map({usersData, lang, handleLink, theme}) {
    if (usersData.mazeref || (usersData.street == 'Orgkollektivet' || usersData.organizer == 'HUSET')) {
        return (
