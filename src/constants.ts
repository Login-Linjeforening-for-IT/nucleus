export const EXAM_API_URL = "https://dev-exam-api.login.no/api"
...
export const KIOSK_URL = "https://usb.login.no/"
export const LDAP_API_URL = "https://ldap-api.login.no/auth"
export const API = "https://workerbee.login.no/api/"
export const TEST_API = "https://testapi.login.no/api/"
