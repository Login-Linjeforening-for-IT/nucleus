 ...
 * @returns
 */
export default function EventCardLocation({item, theme, lang}: EventCardLocationProps): JSX.Element {
    ...
    return(
        <View style={ES.view2}>
            ...
            <View style={{flexDirection: "row"}}>
                <Text style={{...ES.loc, color: FetchColor({theme, variable: "OPPOSITETEXTCOLOR"})}}>{info.trim()}</Text>
            </View>
        </View>
    )
}