...
import { timeSince } from "@shared/eventComponents/fetch";

export default function DownloadButton(clickedEvents: EventProps[], setDownloadState: React.Dispatch<React.SetStateAction<Date>>, downloadState: Date, calendarID: string, dispatch: Dispatch<AnyAction>, isDark: boolean){
    return(
        <>
